...
/**
 * POST /wso2/apiproducts - per-resource discovery for API Products.
 */
@Slf4j
@RestController
@RequestMapping("/wso2")
@RequiredArgsConstructor
public class Wso2ApiProductsController {

    private final Wso2ApiProductsDiscoveryService service;
    ...
    public ResponseEntity<DiscoverResourceResponse> discover(@Valid @RequestBody DiscoverResourceRequest req) {
        applyDefaults(req);
        log.info("POST /wso2/apiproducts company={} tenant={} env={} txn={}",
