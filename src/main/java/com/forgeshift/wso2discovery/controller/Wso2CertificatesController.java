...
/**
 * POST /wso2/certificates - per-resource discovery for endpoint TLS certificates.
 */
@Slf4j
@RestController
@RequestMapping("/wso2")
@RequiredArgsConstructor
public class Wso2CertificatesController {

    private final Wso2CertificatesDiscoveryService service;
    ...
    public ResponseEntity<DiscoverResourceResponse> discover(@Valid @RequestBody DiscoverResourceRequest req) {
        applyDefaults(req);
        log.info("POST /wso2/certificates company={} tenant={} env={} txn={}",
