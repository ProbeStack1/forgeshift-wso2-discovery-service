...
/**
 * POST /wso2/scopes - per-resource discovery for shared OAuth2 scopes.
 */
@Slf4j
@RestController
@RequestMapping("/wso2")
@RequiredArgsConstructor
public class Wso2ScopesController {

    private final Wso2ScopesDiscoveryService service;
    ...
    public ResponseEntity<DiscoverResourceResponse> discover(@Valid @RequestBody DiscoverResourceRequest req) {
        applyDefaults(req);
        log.info("POST /wso2/scopes company={} tenant={} env={} txn={}",
