...
/**
 * POST /wso2/subscriptions - per-resource discovery for app ↔ API subscriptions.
 */
@Slf4j
@RestController
@RequestMapping("/wso2")
@RequiredArgsConstructor
public class Wso2SubscriptionsController {

    private final Wso2SubscriptionsDiscoveryService service;
    ...
    public ResponseEntity<DiscoverResourceResponse> discover(@Valid @RequestBody DiscoverResourceRequest req) {
        applyDefaults(req);
        log.info("POST /wso2/subscriptions company={} tenant={} env={} txn={}",
